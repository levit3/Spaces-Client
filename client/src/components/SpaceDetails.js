...
function SpaceDetails() {
  ...
  useEffect(() => {
    fetch("http://localhost:5555/api/spaces/3/")
      .then((res) => res.json())
      .then((data) => {
        setSpace(data);
        setLoading(true)
